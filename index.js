...
// --- ❌ የአድሚን ማጥፊያ ዝርዝር መክፈቻ ዳታቤዝ (Admin Delete Panal) ---
...
// --- 🗑️ ከዳታቤዝ ውስጥ የማጥፊያ እርምጃዎች (The actual Delete Logic) ---
...
bot.on('text', async (ctx, next) => {
    ...
    try {
        ...
        // --- TRUCK LOGIC ---
            ...
            ctx.reply('3. የሚሰራበትን የጉዞ መስመር ያስገቡ፡');
