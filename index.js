...
bot.action('cement_active', async (ctx) => { 
    ...
    if(data) await ActiveLog.create({ userId: ctx.from.id, name: ctx.from.first_name || 'ተጠቃሚ', category: '🧱 ሲሚንቶ ሻጭ', detail: data.companyName || 'ድርጅት', dateStr: getTodayDateString() });
